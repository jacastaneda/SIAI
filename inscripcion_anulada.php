                ...
                <ul id="main-menu">
                    <div id="identidad">
                        <div id="indicador_estado">
                            ...
                            <p id="estado_actualizar" class="posicion_actual">Inscripció Anulada</p>
                            ...
                            <section class="feature-text">
                                <div id="general">
                                    <div id="transaccional">
                                        ...
                                        <div id="principal">
                                            <h2>Inscripción Anulada</h2>
                                            <p>Se ha anulado tu proceso de inscripción, para continuar el mismo acercarse a las instalaciones de la universidad.</p>
                                        </div>                                        
                                    </div>
                                </div>
                            </section>
