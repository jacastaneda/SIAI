...
<script type="text/javascript" src="../JS/jQueryUI/js/jquery_1.8.js"> </script>
...
<form action="javascript:void(null)" method="post" id="carga" name="carga">
  ...
  <p>
    <input type="submit" name="button2" id="button2" value="Cargar Datos" onclick="xajax_Cargar_Archivo(xajax.getFormValues('carga'))"/>
  </p>
</form>
</center>
