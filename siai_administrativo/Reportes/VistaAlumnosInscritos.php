...
<div class="container">
	<div class=" well well-small">Reporte de materias inscritas</div>
<div class="well">
    <center>   
        ...
        <br></br>        
        <iframe id="frameinscripcion" src="DataTables/AlumnosInscritos.php" height="700px" width="900px" border="0"  frameborder="0" ></iframe>
    </center>
</div>
...
<script>
    $('#codigo_car').on('change', function(){
        $('#frameinscripcion').attr('src','DataTables/AlumnosInscritos.php?carrera='+$(this).val());
    })
</script>    
