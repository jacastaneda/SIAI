...
class SiaiObligaciones{
     ...
     {
          $atributos= array( "arancel","fecha_emision","fecha_pago","nui","valor","id_arancel","cuota","ciclo","anio","npe","descripcion","estado","codigo_barras","usuario" );
     ...
     {
           $atributos=array( $this->arancel , $this->fechaemision , $this->fechapago , $this->nui , $this->valor , $this->idarancel , $this->cuota , $this->ciclo , $this->anio , $this->npe , $this->descripcion , $this->estado , $this->codigobarras , $this->usuario );
