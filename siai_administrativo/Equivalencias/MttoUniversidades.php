...
<div class="container">
	<div class=" well well-small"><!-- InstanceBeginEditable name="EditRegion3" -->
	  <h4><span class="full_width big">Instituci&oacute;n de Educaci&oacute;n Superior </span></h4>
	<!-- InstanceEndEditable --></div>

<div class="well"><!-- InstanceBeginEditable name="EditRegion4" --><center>
<iframe src="DataTables/Universidad.php" height="700px" width="900px" border="0"  frameborder="0" ></iframe></center>
