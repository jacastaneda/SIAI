...
<html lang="en">
    ...
    <body>
        ...
        <div class="content-to-populate-in-modal" id="modal-content-1">
            <h3>Verificador</h3>
            <p><img data-img-src="../assets/images/other_images/appbar.alert.png" class="lazy rounded_border hover_effect pull-left">El verificador no coincide con el enviado.</p>
        </div>
        <div class="content-to-populate-in-modal" id="modal-content-2">
            <h3>Verificador</h3>
            <p><img data-img-src="../assets/images/other_images/appbar.alert.png" class="lazy rounded_border hover_effect pull-left">No se pudo realizar la activaciÃ³n del usuario, intentelo en otro momento.</p>
        </div>
        ...
        <?php if ($verificador == $_GET['verificador']): ?>
            <?php if ($usuario->updateSiaiUsuario()): ?>
                <script>
                            $(document).ready(function (e) {
                                populate_and_open_modal(e, 'modal-content-3');
            ...
            <?php else: ?>
                <script>
                    $(document).ready(function (e) {
                        populate_and_open_modal(e, 'modal-content-2');
                        setInterval(function () {
                            location.href = "../index.php";
                        }
                        , 6000);
        ...
        <?php else: ?>
            <script>
                $(document).ready(function (e) {
                    populate_and_open_modal(e, 'modal-content-1');
                    setInterval(function () {
                        location.href = "../index.php";
                    }
                    , 6000);
