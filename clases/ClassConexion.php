...
class MySQL
{
	...
	private $cod;
	private $bd;
	// atributos que al almacenar�n los nombres de la tabla a consultar, de los columnas y de la llave primaria
	private $tabla;
	private $atributos;
	...
	//funci�n para borrar un registro por medio de la llave primaria
	...
	//funci�n para crear listado, parametros necesarios el atributo por el cual se quiere ordenar y el orden si es ASC o DESC
	...
	//funci�n para hacer consultas genericas, devuelve un arreglo con el resultado
